...
public interface IPaymentService
{
    ...
    Task<ApiResponse<PendingOrderSummaryResponse>> GetPendingSummaryAsync(Guid orderId, CancellationToken cancellationToken = default);
    Task<ApiResponse<CancelPendingOrderResponse>> CancelPendingAsync(Guid orderId, CancellationToken cancellationToken = default);
